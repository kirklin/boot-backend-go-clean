// Package openapi provides a thin wrapper around gin.RouterGroup that
// collects OpenAPI 3.1 metadata at route registration time and serves
// the generated spec + interactive documentation UI.
//
// Controllers remain plain gin.HandlerFunc — this package never touches
// the handler signatures. The generic type parameters on Post/Get/… are
// used exclusively for JSON Schema reflection at startup.
package openapi
